...
echo export LD_LIBRARY_PATH=/mnt/scratch/applications/OpenFOAM/intel64_lin:$LD_LIBRARY_PATH >> /home/$USER/.bashrc
echo export FOAM_INST_DIR=/mnt/scratch/applications/OpenFOAM >> /home/$USER/.bashrc
echo source /mnt/scratch/applications/OpenFOAM/OpenFOAM-2.3.x/etc/bashrc >> /home/$USER/.bashrc
